...
class MFRC522:
    ...
    def _tocard(self, cmd, send, bit_count=None):
        ...
        if bit_count is not None and bit_count % 8 != 0:
            print((bit_count % 8) | 0x80)
            self._wreg(0x0D, (bit_count % 8) | 0x80)  # Ajustar el registro BitFramingReg
